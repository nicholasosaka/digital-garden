...
---
The commonplace term for when a large language model (LLM) produces probable yet false information is "[hallucination](https://arxiv.org/abs/2311.05232)." There are several issues with this term. 
